...
public class CrazyGenerics {
    ...
    static class CollectionUtil {
        ...
        public static <T extends BaseEntity> T findMostRecentlyCreatedEntity(Collection<? extends T> entities) throws NoSuchMethodException {
            return findMax(entities, CREATED_ON_COMPARATOR).orElseThrow(NoSuchMethodException::new);
        }
